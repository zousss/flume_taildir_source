...
public class WinFileUtil {
    ...
    public static String getFileId(String filepath) {
        ...
        com.zjw.source.Kernel32.BY_HANDLE_FILE_INFORMATION lpFileInformation = new com.zjw.source.Kernel32.BY_HANDLE_FILE_INFORMATION();
        HANDLE hFile = null;
        ...
        if (Kernel32.INSTANCE.GetLastError() == 0) {
            ...
            com.zjw.source.Kernel32.INSTANCE
